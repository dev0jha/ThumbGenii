        ...
        <div className="container">
          <div className="home-hero-content">
            ...
            <p className="home-subtitle">
              Generate stunning, CTR-optimized thumbnails with AI. Perfect for
        ...
        <div className="container">
          ...
          <div className="home-features-grid">
            <div className="home-feature-card">
              ...
              <h3>AI Generation</h3>
              <p>
                Describe your vision and let Grok AI create stunning thumbnails
                in seconds.
              </p>
            </div>
            <div className="home-feature-card">
              ...
              <h3>Smart Scoring</h3>
              <p>
                Get AI-powered CTR predictions and actionable feedback to
            ...
            <div className="home-feature-card">
              ...
              <p>
                Automatically generate variants optimized for YouTube, Shorts,
            ...
            <div className="home-feature-card">
              ...
              <p>
                Not sure what to type? Let our AI enhance your prompts for
                better results.
              </p>
            </div>
          </div>
      ...
      <section className="home-styles">
        <div className="container">
          ...
          <p className="home-section-desc">
            From YouTube thumbnails to viral shorts — choose from 16 expertly
            crafted styles.
          </p>
          <div className="home-styles-grid">
            {[
              ...
              <div key={s} className="home-style-chip">
                {s}
              </div>
            ))}
          </div>
